...
public class AppGUI implements AppStyleArbiter {
    ...
    /**
     * Accessor method for getting the App toolbar within which all
     * user interface controls are ultimately placed.
     * 
     * @return This application GUI's app pane.
     */
    public HBox getAppToolbar() { return appToolbar; }
    ...
    private void initWindow() {
        ...
        appToolbar = new HBox();
        appToolbar.getChildren().add(fileToolbarPane);
    ...
    public void updateButtonVisble(Button button) {
        button.setDisable(false);
    }
    
    public void updateButtonDisable(Button button) {
	...
	fileToolbarPane.getStyleClass().add(CLASS_FILETOOLBAR_PANE);
