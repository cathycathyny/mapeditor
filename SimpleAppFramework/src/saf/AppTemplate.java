...
public abstract class AppTemplate extends Application {
	...
	yesNoDialog.init(primaryStage);
        NewMapDialog newMap = NewMapDialog.getSingleton();
        newMap.init(primaryStage);
        ChangeDimensionDialog newDimension = ChangeDimensionDialog.getSingleton();
        newDimension.init(primaryStage);
	SubRegionDialog subregionDetail = SubRegionDialog.getSingleton();
        subregionDetail.init(primaryStage);
        Progressing progress = Progressing.getSingleton();
        progress.init(primaryStage);
